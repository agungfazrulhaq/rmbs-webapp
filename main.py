...
from app.routers import route, auth, users, booking, admin_route, rooms
...
app.include_router(admin_route.router, prefix='/admin', tags=['administration'])
# app.include_router(rooms.route, prefix='')
